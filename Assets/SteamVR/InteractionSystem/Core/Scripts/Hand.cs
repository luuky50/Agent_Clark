...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Hand : MonoBehaviour
    {
        ...
        public SteamVR_Action_Boolean dropWeapon = SteamVR_Input.GetAction<SteamVR_Action_Boolean>("DropWeapon");
        ...
        public bool IsGrabEnding(GameObject attachedObject)
        {
            ...
            {
                if (attachedObjects[attachedObjectIndex].attachedObject == attachedObject && dropWeapon.GetStateDown(handType))
                {
